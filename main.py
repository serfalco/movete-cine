...
- <output>/index.html              portada vigente de Cine
...
def enriquecer_con_tmdb(tradicional, cache_path: Path):
    ...
    print(f"[main] TMDb: {nuevos} títulos nuevos buscados, {len(no_encontrados)} sin match.", file=sys.stderr)
